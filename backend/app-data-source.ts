...
export const myDataSource = new DataSource({
    ...
    database: "postgres",
    entities: ["./src/entity/customer.entity.ts","./src/entity/restaurant.entity.ts","./src/entity/city.entity.ts","./src/entity/items.entity.ts","./src/entity/cartItems.entity.ts","./src/entity/order.entity.ts","./src/entity/orderItems.entity.ts"],
    logging: true,
    synchronize: true,
})
